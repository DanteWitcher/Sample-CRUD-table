...
function sort() {
    $.ajax({
        ...
        // Check !!! This function, probably it's NOT NEED!
...
$(document).ready(function() { //при загрузке страницы:
    //@param for saving of the previous name th event
    let previousTarget = 'firstClick';


    $('.backpopup,.close,.cancel').on('click', function() { //событие клик на тень и крестик - закрываем окно и тень:
